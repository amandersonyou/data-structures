...
primary key, and the date as my sort key. NOTE: I tried changing date to be a 
number instead of a string, but I kept receiving more errors with my queries. 
I am setting my date string to be .toISOstring per student and TA feedback. */
